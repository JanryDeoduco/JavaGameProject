...
public class MainOver extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Image gifImage = new Image("images/DEFEAT.gif");
        ...
        backButton.setOnAction(event -> { // Close the current window
        	
        	Stage mainStage = new Stage();
            Main mainMenu = new Main  (); // Assuming MainMenu is the class representing your main menu
            mainMenu.start(mainStage);// Start Main using the existing stage
            primaryStage.close();
        });
